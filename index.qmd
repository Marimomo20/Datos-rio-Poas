...
# Agregar la serie filtrada de VEGA_E en el eje primario (izquierdo)
fig <- fig %>% add_trace(
...
fig <- fig %>% layout(
  ...
  yaxis2 = list(
    ...
    overlaying = "y",
    showgrid = TRUE,
    title_standoff = 30,  # Ajusta la distancia entre el título y el eje
    ticklen = 6,          # Ajusta la longitud de las marcas de los ticks
    tickangle = 0         # Puedes ajustar el ángulo si los números siguen siendo cortados
  ),
  legend = list(
  ...
  width = 800,
  height = 450,
  margin = list(r = 100)  # Ajusta el margen derecho para dar espacio al eje secundario
)
